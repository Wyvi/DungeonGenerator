...
namespace DungeonGeneratorTests.StructuresTests
{
    ...
    public class RectangleTest
    {
        ...
        {
            var room1 = new Room(new Vector2Int(0, 0), new Vector2Int(1, 1), new DungeonSettings());
            var room2 = new Room(new Vector2Int(0, 0), new Vector2Int(1, 1), new DungeonSettings());
        ...
        {
            var room1 = new Room(new Vector2Int(0, 0), new Vector2Int(1, 1), new DungeonSettings());
            var room2 = new Room(new Vector2Int(1, 1), new Vector2Int(1, 1), new DungeonSettings());
        ...
        {
            var room1 = new Room(new Vector2Int(0, 0), new Vector2Int(1, 1), new DungeonSettings());
            var room2 = new Room(new Vector2Int(2, 2), new Vector2Int(1, 1), new DungeonSettings());
